...
set_property  ip_repo_paths  ../../kernel/${project_name}/${project_name}/${project_name}/impl/ip [current_project]
...
create_bd_cell -type ip -vlnv xilinx.com:Vitis_DSP_Library:matrix_mult:1.0 matrix_mult_0

apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {Auto} Clk_slave {Auto} Clk_xbar {Auto} Master {/processing_system7_0/M_AXI_GP0} Slave {/matrix_mult_0/s_axi_CTRL} ddr_seg {Auto} intc_ip {New AXI Interconnect} master_apm {0}}  [get_bd_intf_pins matrix_mult_0/s_axi_CTRL]
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {Auto} Clk_slave {Auto} Clk_xbar {Auto} Master {/matrix_mult_0/m_axi_gmem} Slave {/processing_system7_0/S_AXI_HP0} ddr_seg {Auto} intc_ip {New AXI Interconnect} master_apm {0}}  [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
...
catch { config_ip_cache -export [get_ips -all ${design_name}_matrix_mult_0_0] }
...
launch_runs ${design_name}_processing_system7_0_0_synth_1 ${design_name}_matrix_mult_0_0_synth_1 ${design_name}_auto_pc_0_synth_1 ${design_name}_rst_ps7_0_50M_0_synth_1 ${design_name}_auto_pc_1_synth_1 ${design_name}_auto_us_0_synth_1 -jobs 8
