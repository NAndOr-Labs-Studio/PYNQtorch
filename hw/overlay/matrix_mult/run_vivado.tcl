...
set_property  ip_repo_paths  ../../kernel/${PROJ}/${PROJ}/${SOLN}/impl/ip [current_project]
...
create_bd_cell -type ip -vlnv xilinx.com:hls:${PROJ}:1.0 ${PROJ}_0

apply_bd_automation -rule xilinx.com:bd_rule:axi4 \
  -config "Clk_master {Auto} Clk_slave {Auto} Clk_xbar {Auto} \
           Master {/processing_system7_0/M_AXI_GP0} \
           Slave {/${PROJ}_0/s_axi_CTRL} \
           ddr_seg {Auto} intc_ip {New AXI Interconnect} \
           master_apm {0}" \
  [get_bd_intf_pins ${PROJ}_0/s_axi_CTRL]

apply_bd_automation -rule xilinx.com:bd_rule:axi4 \
  -config "Clk_master {Auto} Clk_slave {Auto} Clk_xbar {Auto} \
           Master {/${PROJ}_0/m_axi_gmem} \
...
catch { config_ip_cache -export [get_ips -all ${DSGN}_${PROJ}_0_0] }
...
launch_runs ${DSGN}_processing_system7_0_0_synth_1 ${DSGN}_${PROJ}_0_0_synth_1 ${DSGN}_auto_pc_0_synth_1 ${DSGN}_rst_ps7_0_50M_0_synth_1 ${DSGN}_auto_pc_1_synth_1 ${DSGN}_auto_us_0_synth_1 -jobs ${JOBS}
